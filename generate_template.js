...
function generateTemplate(operatingMode, swingMode, fanMode) {
  ...
  if (fs.existsSync(jsonPath)) {
    ...
    console.error(
      `   To prevent overwriting existing data, the operation was cancelled.`,
    );
    console.error(
      `   If you need to regenerate, please delete or rename the existing file first.\n`,
    );
    return null;
  }
  ...
  const hasPowerSaving =
    allParams.includes("power_saving") ||
    allParams.includes("power_saving_plus");
